...
def vaayu_act_one():
    return "As Fili, Kili, Dori, Nori and Ori drive towards the lonely mountain, the extremely loud music coming from their JBL Go 3 speakers attract the attention of some corrupt goblins. They are stopped, and are asked for their licence and registration, which none of them had. The goblins instead ask for copper coins or other favours. Not willing to injure their dignity, a fight breaks out. Fili, Kili, Dori, Nori and Ori are all captured, with the party bus slightly but drivable."
